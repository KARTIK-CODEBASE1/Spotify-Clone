...
const songSections = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        audio: '/music/billie-eilish_Preview.mp3',
      },
      {
        title: 'Money Trees',
        artist: 'Kendrick Lamar',
        cover: '/cover-art/money_trees.jpg',
        audio: '/music/kendrick-lamar_Preview.mp3',
      },
      {
        title: 'BAD BUNNY x JHAY CORTEZ - DÁKITI',
        artist: 'Bad Bunny',
        cover: '/cover-art/bad_bunny.jpg',
        audio: '/music/bad-bunny_Preview.mp3',
      },
      {
        title: 'Taylor Swift - Shake It Off',
        artist: 'Taylor Swift',
        cover: '/cover-art/shake_it_off.png',
        audio: '/music/taylor-swift_Preview.mp3',
      },
      {
        title: 'The Weeknd - Blinding Lights',
        artist: 'The Weeknd',
        cover: '/cover-art/blinding_lights.png',
        audio: '/music/blinding-lights_Preview.mp3',
      },
      {
        title: 'The Kill 2',
        artist: 'Lex Amarni',
      ...
      },
      {
        ...
        audio: '/music/don-toliver-no-pole_Preview.mp3',
      },
      {
