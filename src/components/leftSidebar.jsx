    ...
    <aside className="flex h-full min-h-0 flex-col overflow-hidden rounded-xl bg-[#121212]">
      <div className="flex items-center justify-between px-4 pb-3 pt-4">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex h-10 w-25 gap-2 font-bold text-sm shrink-0 items-center justify-center rounded-full bg-[#1f1f1f] transition duration-200 hover:bg-[#2a2a2a]"
          >
            <img
              className="h-5 w-5"
              style={iconFilter}
      ...
      <div className="flex-1 overflow-hidden px-1 pb-72">
        <div className="space-y-2">
          {libraryCards.map((card) => (
            ...
            >
              ...
              <button
                type="button"
                className="mt-5 rounded-full bg-white px-5 py-2.5 text-sm font-bold text-black transition duration-200 hover:scale-[1.02]"
              >
                {card.action}
              </button>
            </article>
        ...
        <div className="px-4 pt-10">
          ...
          <button
            type="button"
            className="mt-5 flex items-center gap-3 rounded-full border border-[#727272] py-1 pl-2 pr-[14px] text-sm font-bold text-white transition duration-200 hover:border-white hover:scale-[1.03]"
          >
            <img
              className="h-5 w-5"
              style={iconFilter}
